      ...
      body: Builder(builder: (context) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle.light.copyWith(
              statusBarColor:
                  (Platform.isAndroid) ? Colors.black : Colors.white),
          child: SingleChildScrollView(
            child: Column(
              children: [
                const Header(),
                Navigation(
                    onPressedMenuIcon: () => Scaffold.of(context).openDrawer()),
                Padding(
                  padding: const EdgeInsets.only(left: 16, top: 40),
                  child: InkWell(
                    onTap: () => _mainScreenBloc
                        .add(const MainScreenEventLoadFavoritesQuestions()),
                    child: const Row(
                      children: [
                        Text(
                          "Mostrar favoritos:",
